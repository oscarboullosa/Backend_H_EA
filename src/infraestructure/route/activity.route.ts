...
routeActivity.get(
  "/activity/:uuid",
  checkJwt,
  activityCtrl.getActivityByIdCtrl
); //OK
routeActivity.get("/activities/all", checkJwt, activityCtrl.listActivityCtrl); //OK
routeActivity.get(
  "/activity/paginated/:numPage",
  checkJwt,
  activityCtrl.listActivityPagCtrl
); //OK
routeActivity.get(
  "/activity/all/participants/:uuid/:numPage",
  checkJwt,
  activityCtrl.getParticipantsOfActivityCtrl
); //NO ok
routeActivity.get(
  "/activity/all/count/docs",
  checkJwt,
  activityCtrl.getNumActivityCtrl
); //OK
routeActivity.get(
  "/activity/myweek/:uuid/:date",
  checkJwt,
  activityCtrl.getActivitiesByUserAndWeekCtrl
);
routeActivity.get(
  "/activity/following/:uuid/:numPage/:date",
  checkJwt,
...
routeActivity.get("/activity/monthyear/:uuid/:month/:year",checkJwt,activityCtrl.getActivitiesByMonthAndYearCtrl);
...
routeActivity.delete(
  "/activity/:uuid",
  checkJwt,
  activityCtrl.deleteActivityCtrl
); //OK

routeActivity.get(
  "/activities/bylocation/:locationId",
  checkJwt,
  activityCtrl.getActivitiesByLocationCtrl
);

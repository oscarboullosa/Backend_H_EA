...
routeUser.get(
  "/user/follower/:uuid/:numPage",
  checkJwt,
  userCtrl.listFollowersPagCtrl
); //ok
routeUser.get(
  "/user/followed/:uuid/:numPage",
  checkJwt,
  userCtrl.listFollowedPagCtrl
); //ok
routeUser.get(
  "/user/isFollower/:uuid/:uuidFollowed",
  checkJwt,
  userCtrl.checkFollowerCtrl
); //ok
...
routeUser.post(
  "/user/loginfrontendgoogle",
  userCtrl.loginFrontendGoogleUserCtrl
);

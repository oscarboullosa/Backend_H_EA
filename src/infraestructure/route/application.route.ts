...
routeApplication.get(
  "/application/:uuid",
  checkJwt,
  applicationCtrl.getApplicationByIdCtrl
); //OK
routeApplication.get(
  "/applications/all",
  checkJwt,
  applicationCtrl.listApplicationCtrl
); //OK
routeApplication.get(
  "/application/paginated/:numPage",
  checkJwt,
  applicationCtrl.listApplicationPagCtrl
); //OK
routeApplication.get(
  "/application/all/count/docs",
  checkJwt,
  applicationCtrl.getNumApplicationsCtrl
); //OK

routeApplication.post(
  "/application/add",
  checkJwt,
  applicationCtrl.insertApplicationCtrl
); //OK

routeApplication.put(
  "/application/:uuid",
  checkJwt,
  applicationCtrl.updateApplicationCtrl
); //OK

routeApplication.delete(
  "/application/:uuid",
  checkJwt,
  applicationCtrl.deleteApplicationCtrl
); //OK

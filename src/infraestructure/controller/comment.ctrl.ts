...
export class CommentController {
  constructor(private commentUseCase: CommentUseCase) {
    this.getCommentPublicationByIdPagCtrl =
      this.getCommentPublicationByIdPagCtrl.bind(this);
    this.insertCommentPublicationCtrl =
      this.insertCommentPublicationCtrl.bind(this);
    this.responseCommentCtrl = this.responseCommentCtrl.bind(this);
    this.updateCommentPublicationCtrl =
      this.updateCommentPublicationCtrl.bind(this);
    this.deleteCommentPublicationCtrl =
      this.deleteCommentPublicationCtrl.bind(this);
  ...
  public async getCommentPublicationByIdPagCtrl(
    { params }: Request,
    res: Response
  ) {
  ...
  public async updateCommentPublicationCtrl(
    { params, body }: Request,
    res: Response
  ) {
    const { uuid = "" } = params;
    ...
    const response = await this.commentUseCase.updateCommentPublication(
      uuid,
      body
    );
    res.send(response);
  ...
  public async deleteCommentPublicationCtrl(
    { params }: Request,
    res: Response
  ) {
    const { uuid = "" } = params;

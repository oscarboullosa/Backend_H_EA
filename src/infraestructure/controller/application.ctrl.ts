...
export class ApplicationController {
  ...
  public async getApplicationByIdCtrl({ params }: Request, res: Response) {
    const { uuid = "" } = params;
    const response = await this.applicationUseCase.getApplicationById(
      `${uuid}`
    );
    res.send(response);
  }
  ...
  public async updateApplicationCtrl({ params, body }: Request, res: Response) {
    const { uuid = "" } = params;
    const response = await this.applicationUseCase.updateApplication(
      `${uuid}`,
      body
    );
    res.send(response);
  ...
  public async listApplicationPagCtrl({ params }: Request, res: Response) {
    ...
    const response = await this.applicationUseCase.listApplicationPag(
      `${numPage}`
    );
    res.send(response);
  }
